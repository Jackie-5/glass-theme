define([], function(){
	...
	var renderDOM = function(){
		...
		var tagStr = $tag?'<span class="viewer-title">标签<span>Tags</span></span><div class="viewer-div tagcloud" id="js-mobile-tagcloud"></div>':"";
		var friendsStr = $friends?'<span class="viewer-title">友情链接<span>Links</span></span><div class="viewer-div friends" id="js-mobile-friends"></div>':"";
		var aboutmeStr = $aboutme?'<span class="viewer-title">关于我<span>About</span></span><div class="viewer-div aboutme" id="js-mobile-aboutme"></div>':"";
	...
	return{
		init: function(){
            ...
            document.getElementById('tocButton') && (document.getElementById('tocButton').style.display = 'none');
			//构造四步
			reset();
			renderDOM();
			combine();
